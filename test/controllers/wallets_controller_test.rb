...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { amount: @wallet.amount, user_id: @wallet.user_id } }, as: :json
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { amount: @wallet.amount, user_id: @wallet.user_id } }, as: :json
    assert_response :success
  end
